...
class DbService {
  ...
  async addAttendanceRecord(record: Omit<AttendanceRecord, 'id' | 'captured_photo_url'>, photoBase64: string): Promise<AttendanceRecord> {
    const photoUrl = await uploadAttendancePhoto(record.collaborator_id, photoBase64);
