...
async function migrate() {
    ...
    try {
        await turso.execute('ALTER TABLE attendance_records ADD COLUMN location_name TEXT;');
        console.log('Added location_name');
    } catch (e: any) {
        console.log('location_name might already exist: ', e.message);
    }
